      ...
      <>
        {!editMode ? (
          ...
          <li className="list-group-item">
            ...
            <span
              onClick={() => this.handleEditMode(id)}
          ...
          <li className="list-group-item">
            <form
              onSubmit={
                isName(newName)
                  ? (e) => this.handleEdit(e, id)
                  : this.handleNameError
              }
              className="form"
            >
              <div className="float-left">
                <label htmlFor="editPlayer" className="help-block">
                  Edit Player Name
                </label>
                <input
                  type="text"
              ...
              <button className="btn btn-success btn-sm float-right mx-2">
                Done
              </button>
            </form>
          </li>
...

        {
          ...
          !error ? null : (
            <p className="alert alert-danger m-0 rounded-0">
