...
const isName = (name) =>
  RegExp("^[a-zA-Z]+(([',. -][a-zA-Z ])?[a-zA-Z]*)*$", "g").test(name);
      ...
      <>
        <div className="p-5 overflow-auto col-md-12">
          ...
          <h5 className="text-center mb-3">
            Please add the names of all players
          </h5>
          <div className="container-settings">
            <div>
              <form
                onSubmit={
                  validName ? this.handleSubmitName : this.handleNameError
                }
                className="clearfix"
              >
                <div>
                  <label htmlFor="names" className="help-block">
                    Add Player
                  </label>
                  <input
                ...
                {validPlayers || players.length === 0 ? null : (
                  <p className="alert alert-warning mt-3">
                    The number of players must be a power of 2 e.g. 2, 4, 8, 16,
                    32...
                  </p>
                )}
              </form>
              ...
              <form
                onSubmit={
                  validPlayers
                    ...
                    : this.handlePlayersError
                }
                className="form mt-3 p-0"
              >
                <label htmlFor="winningScore" className="help-block">
